...
dRemote %>% replyr::replyr_filter('x', values)
 #  # Source:   table<replyr_filter_wtexje59ykpma5vtj9ik_0000000001> [?? x 3]
...
gc()
 ...
 #  Ncells  692906 37.1    1168576 62.5   940480 50.3
 #  Vcells 1440823 11.0    2552219 19.5  1691486 13.0
```
