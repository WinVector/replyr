...
As a diagram the key structure of the join plan looks like the following (produced by `DiagrammeR::grViz(makeJoinDiagramSpec(columnJoinPlan))`):

<img src="joinDiagram1.png" width="600">

These diagrams are kind of fun.  For instance, here is a more complicated one from the `help(makeJoinDiagramSpec)` examples:

<img src="joinDiagram2.png" width="600">

Some examples and instructions on how to save as png files can be found [here](https://github.com/WinVector/replyr/blob/master/extras/graphViz.md).
